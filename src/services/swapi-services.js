export default class SwapiService{
    ...
    _imageBaes = 'https://starwars-visualguide.com/assets/img';
    ...
    getPersonImage = ({id}) => {
        return `${this._imageBaes}/characters/${id}.jpg`
    }

    getStarshipImage = ({id}) => {
        return `${this._imageBaes}/starships/${id}.jpg`

    }

    getPlanetImage = ({id}) => {
        return `${this._imageBaes}/planets/${id}.jpg`
